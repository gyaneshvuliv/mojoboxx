			...
			if ( is_wp_error( $media_array ) ) {
				...
				foreach( $media_array as $item ) {
					...
					if ( locate_template( $template_part ) !== '' ) {
						...
						echo '<li class="' . esc_attr( $liclass ) . '"><a href="' . esc_url( $item['link'] ) . '" target="' . esc_attr( $target ) . '"  class="' . esc_attr( $aclass ) . '"><div class="image-loading"></div><div class="image-preloader"></div><img src="' . esc_url( $item[$size] ) . '"  alt="' . esc_attr( $item['description'] ) . '" title="' . esc_attr( $item['description'] ) . '"  class="' . esc_attr( $imgclass ) . '"/></a></li>';
					}
				}
				?></ul><?php
			}
