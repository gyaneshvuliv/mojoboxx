...
class  Enovathemes_Addons_WP_Widget_Twitter extends WP_Widget {
	...
	public function widget($args, $instance){
		...
		$consumer_key        = (isset($globax_enovathemes['tweets-consumer-key']) && !empty($globax_enovathemes['tweets-consumer-key'])) ? esc_attr($globax_enovathemes['tweets-consumer-key']): "";
		$consumer_secret     = (isset($globax_enovathemes['tweets-consumer-secret']) && !empty($globax_enovathemes['tweets-consumer-secret'])) ? esc_attr($globax_enovathemes['tweets-consumer-secret']) : "";
		$access_token        = (isset($globax_enovathemes['tweets-access-token']) && !empty($globax_enovathemes['tweets-access-token'])) ? esc_attr($globax_enovathemes['tweets-access-token']) : "";
		$access_token_secret = (isset($globax_enovathemes['tweets-access-token-secret']) && !empty($globax_enovathemes['tweets-access-token-secret'])) ? esc_attr($globax_enovathemes['tweets-access-token-secret']) : "";
