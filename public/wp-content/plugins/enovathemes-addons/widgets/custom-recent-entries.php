...
function enovathemes_addons_register_recent_posts_widget(){
	register_widget( 'Enovathemes_Addons_WP_Widget_Recent_Posts' );
}

class Enovathemes_Addons_WP_Widget_Recent_Posts extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : esc_html__( 'Recent Posts', 'enovathemes-addons');
