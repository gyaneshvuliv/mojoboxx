...
final class ServerReporter {
	...
	public function get_fields() {
		return [
			'os'                    => esc_html__( 'Operating System', 'glider-wpbakery' ),
			'software'              => esc_html__( 'Software','glider-wpbakery' ),
			'mysql_version'         => esc_html__( 'MySQL version','glider-wpbakery' ),
			'php_version'           => esc_html__( 'PHP Version','glider-wpbakery' ),
			'write_permissions'     => esc_html__( 'Write Permissions','glider-wpbakery' ),
			'zip_installed'         => esc_html__( 'ZIP Installed','glider-wpbakery' ),
			'curl_installed'        => esc_html__( 'cURL Installed','glider-wpbakery' ),
			'wpbakery_installed'    => esc_html__( 'WPBakery Installed','glider-wpbakery' ),
			/** 'dom_installed'         => esc_html__( 'DOM Installed','glider-wpbakery' ), */
			/** 'xml_installed'         => esc_html__( 'XML Installed','glider-wpbakery' ), */
			/** 'bcmath_installed'      => esc_html__( 'BCMath Installed','glider-wpbakery' ), */
		];
	}
	...
	public function get_php_version() {
		...
		if ( version_compare( $result['value'], '5.6', '<' ) ) {
			$result['recommendation'] = esc_html__( 'We recommend to use php 5.6 or higher', 'glider-wpbakery' );
	...
	public function get_zip_installed() {
		...
		return [
			'value' => $zip_installed ? '<i class="material-icons mdc-system-yes">check_circle</i>' . esc_html__('YES', 'glider-wpbakery') : '<i class="material-icons mdc-system-no">error</i>' . esc_html__('NO', 'glider-wpbakery' ),
	...
	public function get_curl_installed() {
		...
		return [
			'value' => $curl_installed ? '<i class="material-icons mdc-system-yes">check_circle</i>' . esc_html__('YES', 'glider-wpbakery') : '<i class="material-icons mdc-system-no">error</i>' . esc_html__('NO', 'glider-wpbakery' ),
			'warning' => ! $curl_installed,
			'recommendation' => esc_html__('You must enable CURL (Client URL Library) in PHP. Contact the support service of your hosting provider. They know what to do.', 'glider-wpbakery' )
		];
	}
	...
	public function get_wpbakery_installed() {
		...
		if ( defined( 'WPB_VC_VERSION' ) ) {
			$wpbakery_installed = true;
		}

		return [
			'value' => $wpbakery_installed ? '<i class="material-icons mdc-system-yes">check_circle</i>' . esc_html__('YES', 'glider-wpbakery') : '<i class="material-icons mdc-system-no">error</i>' . esc_html__('NO', 'glider-wpbakery' ),
			'warning' => ! $wpbakery_installed,
			'recommendation' => esc_html__('You need install and activate WPBakery builder. Go to WPBakery site (wpbakery.com.com) for details.', 'glider-wpbakery' )
		];
	}
	...
	public function get_dom_installed() {
		...
		return [
			'value' => $dom_installed ? '<i class="material-icons mdc-system-yes">check_circle</i>' . esc_html__('YES', 'glider-wpbakery') : '<i class="material-icons mdc-system-no">error</i>' . esc_html__('NO', 'glider-wpbakery' ),
			'warning' => ! $dom_installed,
			'recommendation' => esc_html__('You must enable DOM extension (Document Object Model) in PHP. It\'s used for HTML processing. Contact the support service of your hosting provider. They know what to do.', 'glider-wpbakery' )
		];
	}
	...
	public function get_xml_installed() {
		...
		return [
			'value' => $xml_installed ? '<i class="material-icons mdc-system-yes">check_circle</i>' . esc_html__('YES', 'glider-wpbakery') : '<i class="material-icons mdc-system-no">error</i>' . esc_html__('NO', 'glider-wpbakery' ),
			'warning' => ! $xml_installed,
			'recommendation' => esc_html__('You must enable XML extension in PHP. It\'s used for XML processing. Contact the support service of your hosting provider. They know what to do.', 'glider-wpbakery' )
		];
	}
	...
	public function get_bcmath_installed() {
		...
		return [
			'value' => $bcmath_installed ? '<i class="material-icons mdc-system-yes">check_circle</i>' . esc_html__('YES', 'glider-wpbakery') : '<i class="material-icons mdc-system-no">error</i>' . esc_html__('NO', 'glider-wpbakery' ),
			'warning' => ! $bcmath_installed,
			'recommendation' => esc_html__('You must enable BCMath extension (Arbitrary Precision Mathematics) in PHP. Contact the support service of your hosting provider. They know what to do.', 'glider-wpbakery' )
		];
	}
	...
	public function get_write_permissions() {
		...
		$paths_to_check = [
			ABSPATH => esc_html__('WordPress root directory', 'glider-wpbakery' )
		];
		...
		if ( $wp_upload_dir['error'] ) {
			$write_problems[] = esc_html__('WordPress root uploads directory', 'glider-wpbakery' );
		}

		$htaccess_file = ABSPATH . '/.htaccess';

		if ( file_exists( $htaccess_file ) ) {
			$paths_to_check[ $htaccess_file ] = esc_html__('.htaccess file', 'glider-wpbakery' );
		}
		...
		if ( $write_problems ) {
			$value = '<i class="material-icons mdc-system-no">error</i>' . esc_html__('There are some writing permissions issues with the following directories/files:', 'glider-wpbakery' ) . "<br> &nbsp;&nbsp;&nbsp;&nbsp;– ";

			$value .= implode( "<br> &nbsp;&nbsp;&nbsp;&nbsp;– ", $write_problems );
		} else {
			$value = '<i class="material-icons mdc-system-yes">check_circle</i>' . esc_html__('All right', 'glider-wpbakery' );
		}
