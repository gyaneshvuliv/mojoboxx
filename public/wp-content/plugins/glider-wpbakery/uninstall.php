...
final class Uninstall {
	...
	private function __construct() {
		...
		Helper::get_instance()->send_action( 'uninstall', 'glider-wpbakery', '1.0.1' );
	...
	public function get_uninstall_mode() {
		...
		if( isset( $uninstall_settings['mdp_glider_wpbakery_uninstall_settings'] ) AND $uninstall_settings['mdp_glider_wpbakery_uninstall_settings'] ) { // Default value.
			$uninstall_settings = [
	...
	public function remove_settings() {
		...
		$settings = [
			'mdp_glider_wpbakery_envato_id',
			'mdp_glider_wpbakery_settings',
			'mdp_glider_wpbakery_uninstall_settings',
