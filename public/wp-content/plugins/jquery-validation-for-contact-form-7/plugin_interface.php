...
if (isset($_GET['hidemsg']) == 1){
	update_option('jvcf7_hide_pro_notice','yes_7');
}

function jvcf7_pro_notification(){
	if (get_option('jvcf7_hide_pro_notice') != 'yes_7'){
		 echo '<div class="updated">
       <p><b>Jquery Validation for Contact Form 7 Pro</b> now has<br/>
	   <ol>
	   <li>Additional validation methods like Alphanumeric, Bank or Giro account number, BIC code, Integer, IPv4, IPv6, UK Mobile, UK Phone, US state, Minimum Number, Maximum Number, Minimum Length, Maximum Length, Range Length, Range, Equal To, Extension, Require Group and <strong>Custom Code, Email Code Verification (Verify Email via Code), Check Username</strong>.</li>
