...
final class StatusTab {
	...
	public function add_settings() {
		...
		/** Status Tab. */
		register_setting( 'WorkerWPBakeryStatusOptionsGroup', 'mdp_worker_wpbakery_status_settings' );
		add_settings_section( 'mdp_worker_wpbakery_settings_page_status_section', '', null, 'WorkerWPBakeryStatusOptionsGroup' );
	...
	public function render_form() {
		...
		settings_fields( 'WorkerWPBakeryStatusOptionsGroup' );
		do_settings_sections( 'WorkerWPBakeryStatusOptionsGroup' );
	...
	public function render_system_requirements() {
		...
		<div class="mdc-system-requirements">
			...
			<?php foreach ( $reports as $key => $report ) : ?>
                <div class="mdp-worker-wpbakery-<?php echo esc_attr( $key ); ?>">
	...
	public function render_changelog() {
		...
		$changelog_url = 'https://wpbakery.merkulov.design/changelog.md';
	...
	public function render_privacy_notice() {
        ...
        <div class="mdc-text-field-helper-line">
            <div class="mdc-text-field-helper-text mdc-text-field-helper-text--persistent"><?php esc_html_e( 'Some data will be sent to our server to verify purchase and to ensure that a plugin is compatible with your install. We will never collect any confidential data. All data is stored anonymously.', 'worker-wpbakery' );?></div>
        </div>
        <?php
    }
