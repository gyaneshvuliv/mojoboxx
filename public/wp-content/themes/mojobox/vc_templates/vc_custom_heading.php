...
if ( apply_filters( 'vc_custom_heading_template_use_wrapper', false ) ) {
	...
	$output .= '<' . $font_container_data['values']['tag'] . ' ' . $style . ' data-mobile-font="'.esc_attr($mobile_font_size).'" data-tablet-font="'.esc_attr($tablet_font_size).'" >';
	$output .= $text;
	$output .= '</' . $font_container_data['values']['tag'] . '>';
	$output .= '</div>';
} else {
	$output .= '<' . $font_container_data['values']['tag'] . ' ' . $style . ' class="' . esc_attr( $css_class ) . '" ' . implode( ' ', $wrapper_attributes ) . ' data-mobile-font="'.esc_attr($mobile_font_size).'" data-tablet-font="'.esc_attr($tablet_font_size).'" >';
	$output .= $text;
	$output .= '</' . $font_container_data['values']['tag'] . '>';
}
